...
int Current_Sensor_Y_Axis_Position = Sensor_Position_Setting[0];                    // Y_Axis sensor position.
long Current_Measurement_Reading = 0;                                               // Scan measurement memory.
...
if(Within_Margin(Current_Measurement_Reading, Expected_Readings[Position_Indexer], 5)){                   // ...
Out_Of_Tolerance_Warning=" (PASS)";                                                 // ...
}else{                                                                              // ...
Out_Of_Tolerance_Warning=" (ATTN)";                                                 // ...
}                                                                                   // ...
Upper_LCD_Line = "Position: "+String(Current_Sensor_Y_Axis_Position);               // Set upper LCD line.
...
Sensor_mm = Sensor_mm + Center_Datum_Offset;                                        // Apply sensor offeset to rail.
...
Current_Measurement_Reading = Array_Memory[a][0];                                   // ...
}                                                                                   // ...
}                                                                                   // ...
